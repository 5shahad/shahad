...
# -*- coding: utf-8 -*-
"""
Created on Sat Jul 15 17:43:30 2023
...
def resize_image():
   ...
   #Resize the Image using resize method
    resized_image= tk.img.resize((300,205), Image.ANTIALIAS)
...
def rotate() :
    image = Image.open(file_path)
     # The Image
    rotated_image3 = tk.image.rotate(60)
...
resize_button =tk.Button(left_frame, text="Resize Image", command=resize_image)
resize_button.pack(pady=10)

rotate =tk.Button(left_frame, text="rotate Image", command=rotate)
rotate.pack(pady=10)
